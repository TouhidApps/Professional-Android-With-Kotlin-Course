...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter.setItemClick {
            ...
            if (isLoadingData || binding.swipeRefreshLayout.isRefreshing) {
                Toast.makeText(this, "Loading...", Toast.LENGTH_SHORT).show()
                return@setItemClick
            }

            Toast.makeText(this, "${it.countryName}--${it.countryCode}", Toast.LENGTH_SHORT).show()
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if(dy > 0) {
                    ...
                    recyclerView.layoutManager?.let {
                        ...
                        if (!isLoadingData && !binding.swipeRefreshLayout.isRefreshing && totalItemCount == lm.findLastVisibleItemPosition() + 1) {
                            mPageNo++
                            loadData(mPageNo)
                        }
    ...
    private fun loadData(pageNo: Int) {
        ...
        val isSwiprefresh = (pageNo == 1) && mCountries.isNotEmpty()
